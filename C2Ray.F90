...
Program C2Ray
  ...
  use c2ray_parameters, only: cosmological, type_of_clumping, &
       use_LLS, type_of_LLS,stop_on_photon_violation, control_rank
...
#ifdef MPI
     call MPI_BCAST(iter_restart,1,MPI_INTEGER,control_rank,MPI_COMM_NEW, &
          mympierror)
#endif
  endif
...
#ifdef MPI
     call MPI_BCAST(zred_interm,1,MPI_DOUBLE_PRECISION,control_rank,MPI_COMM_NEW, &
          mympierror)
#endif
